...
const Banner = styled('div')({
  width: '100%',
  height: '50vh',
  backgroundImage: 'url("/src/assets/About/about-banner-1.png")',
...
const tabPanelValues = {
  1: {
    ...
    src: "/src/assets/About/outStory-1.jpeg",
  },
  2: {
    header: "Our Roots",
    ...
    src: "/src/assets/About/ourRoot-2.jpeg",
  },
  3: {
    header: "Our Process",
    ...
    src: "/src/assets/About/ourProcess-3.jpeg",
  },
  4: {
    header: "Our Science",
    ...
    src: "/src/assets/About/ourScience-4.jpeg",
  },
  5: {
    ...
    src: "/src/assets/About/ourInitiatives-5.jpeg",
  },
};
    ...
    <Grid container>
      ...
      <Grid item xs={12}>
        <Box>
          ...
          >
            <StyledTab value="1" label="OUR STORY" wrapped />
